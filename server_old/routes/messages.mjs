...
try {
  const w = await import('../../microservices/userServer/services/messaging/whatsapp.mjs');
  whatsappService = w;
} catch (e) {
  console.warn('WhatsApp integration not available:', e.message);
}
try {
  const t = await import('../../microservices/userServer/services/messaging/telegram.mjs');
  telegramService = t;
} catch (e) {
